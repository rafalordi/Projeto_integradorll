		...
		<div class="container">
			...
			<div class="w3layouts_mail_grids">
				...
				<div class="col-md-8 w3layouts_mail_grid_right">
						...
						<a href="areadedenuncia.php"><input type="submit" value="Fazer uma nova denúncia"></a>
						<a href="consulta.php"><input type="submit" value="Consultar suas denúncias"></a>
			...
			<div class="agile-footer-grids">
				...
				<div class="col-md-2 agile-footer-grid" align="right">
					...
					<li class="text"><a href="indexpessoal.php">Página Inicial</a></li>
						...
						<li class="text"><a href="denuncia.php">Denuncia</a></li>
